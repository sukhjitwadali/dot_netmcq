...
// Initialize quiz with questions from mcq_question.js
...
function createQuestionElement(questionData) {
    ...
    // Create question header with ID and source
    const questionHeader = document.createElement('div');
    questionHeader.className = 'question-header';
    questionHeader.innerHTML = `
        <span class="question-id">${questionData.id}</span>
        <span class="question-source">Source: ${questionData.source}</span>
    `;
...
function showQuestion(index) {
    ...
    // Create and append the current question
    const questionElement = createQuestionElement(quizData[index]);
